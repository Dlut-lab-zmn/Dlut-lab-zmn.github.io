...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="https://arxiv.org/pdf/2402.18211.pdf">Mitigating Error Amplification in Fast Adversarial Training</a></div>
    <div class="author"><strong>Mengnan Zhao</strong>, Lihe Zhang, BoWang, Tianhang Zheng, Hong Zhong, Geyong Min</div>
    <div class="periodical"><em>Computer Vision and Pattern Recognition, 2026.</em></div>
    <div class="pub-rank-badges"><span>Conference</span><span>CCF A</span></div>
    <div class="links">
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="pub-rank-badges"><span>Conference</span><span>CCF B</span><span>CAA A</span></div>
    <div class="links">
...
<div class="pub-row">
  ...
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/shallow.png" class="teaser img-fluid z-depth-1">
    <abbr class="badge">SCIS</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="https://arxiv.org/pdf/2402.18211.pdf">ShallowUnlearn: Rethinking concept unlearning through disentangled component-level erasure in text-guided diffusion models</a></div>
    <div class="author"><strong>Mengnan Zhao</strong>, Tianhang Zheng, Bo Wang, Lihe Zhang, Baocai Yin</div>
    <div class="periodical"><em>中国科学-信息科学, 2026.</em></div>
    <div class="pub-rank-badges"><span>Journal</span><span>CCF A</span></div>
    <div class="links">
    <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
      <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="title"><a href="https://arxiv.org/pdf/2402.18211.pdf">Movable-type eraser: separable, recoverable, and sustainable multi-concept eraser in diffusion models</a></div>
    <div class="author"><strong>Mengnan Zhao</strong>, Lihe Zhang, Baocai Yin</div>
    <div class="periodical"><em>中国科学-信息科学, 2026.</em></div>
    <div class="pub-rank-badges"><span>Journal</span><span>CCF A</span></div>
    <div class="links">
    <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/document/10417771" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/SGG_Attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9808181" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/GEAA-for-data-protection" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="pub-rank-badges"><span>Journal</span><span>SCI I</span><span>CCF B</span></div>
    <div class="links">
    <a href="https://www.sciencedirect.com/science/article/abs/pii/S0031320323009184" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/class-correlation-correction" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <a href="https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9306891" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/Source-attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
Instance Positions</a></div>
    ...
    <div class="pub-rank-badges"><span>Journal</span><span>SCI I</span></div>
    <div class="links">
    <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
      <a href="https://mengnan-zhao-happy.github.io/" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
by Memories</a></div>
    ...
    <div class="pub-rank-badges"><span>Journal</span><span>SCI II</span><span>CCF C</span></div>
    <div class="links">
    <a href="https://arxiv.org/pdf/2110.08765.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/MTDM" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="pub-rank-badges"><span>Journal</span><span>SCI II</span><span>CCF C</span></div>
    <div class="links">
    <a href="https://github.com/AdvLearnLab/Image-Captioning-Attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/Image-Captioning-Attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
      <a href="https://github.com/AdvLearnLab/Image-Captioning-Attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Package</a>
      <a href="https://github.com/AdvLearnLab/Image-Captioning-Attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">BibTeX</a>
      <strong><i style="color:#7b5aa6">arXiv.org</i></strong>
    </div>
  </div>
</div>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="pub-rank-badges"><span>Conference</span></div>
    <div class="links">
    <a href="http://ice.dlut.edu.cn/WangBo/Publications/Conference/FurtherUnderstandingTowardsSparsityAdversarialAttacks-2022.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
      ...
      <a href="https://github.com/AdvLearnLab/Least_pixel_attack" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">GitHub</a>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="pub-rank-badges"><span>Journal</span><span>SCI</span></div>
    <div class="links">
